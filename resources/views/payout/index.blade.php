        ...
        <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
            ...
            <body >
                ...
                <div class="p-24 flex items-center flex-wrap ">
                    ...
                    <a href="{{ route('wallet') }}" :active="request()->routeIs('wallet')"class="bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg">{{ __('Wallet') }}</a> 
                </div>
        </html>
    </div>
</x-app-layout>   
