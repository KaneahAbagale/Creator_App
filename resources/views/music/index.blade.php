                ...
                <div class="p-6">
                  ...
                  <div class="flex items-center flex-wrap ">
                    <?php if ($content->price == 0) {
                      ...
                      echo "<a href='payment.index/".$contentID."' class='bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg'>Download</a>";
                    }
                    ?>
