            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Upload Music</h3>
                    </div>
                </div>
                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        ...
                        <div class="grid grid-cols-3 gap-6">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input type="text" name="cost" id="cost" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="www.example.com">
                            </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-3 gap-6">
                            <div class="col-span-3 sm:col-span-2">
                                <label for="name" value="{{ __('Music') }}" class="block text-sm font-medium text-gray-700"> Cost </label>
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    <select name="cost" id="cost" onchange="musicCreate()" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                            ...
                            <div class="grid grid-cols-3 gap-6" style="display:none" id="ctypediv">
                                <div class="col-span-3 sm:col-span-2">
                                    <label for="name" value="{{ __('Music') }}" class="block text-sm font-medium text-gray-700"> Enter Price </label>
                                    <div class="mt-1 flex rounded-md shadow-sm">
