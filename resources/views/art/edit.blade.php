            ...
            <div class="md:col-span-1">
                ...
                <h3 class="text-lg font-medium leading-6 text-gray-900">Upload Art</h3>
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-2">
                        <form action="{{ route('art.create') }}" method="POST">
                            @csrf
                            <div class="shadow sm:rounded-md sm:overflow-hidden">
                                ...
                                <div class="grid grid-cols-3 gap-6">
                                    ...
                                    <div class="grid grid-cols-3 gap-6">
                                    <div class="col-span-3 sm:col-span-2">
                                        <label for="name" value="{{ __('Art') }}" class="block text-sm font-medium text-gray-700"> Cost </label>
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <select name="cost" id="cost" onchange="artCreate()" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                                    ...
                                    <div class="grid grid-cols-3 gap-6" style="display:none" id="ctypediv">
                                        <div class="col-span-3 sm:col-span-2">
                                            <label for="name" value="{{ __('Art') }}" class="block text-sm font-medium text-gray-700"> Enter Price </label>
                                            <div class="mt-1 flex rounded-md shadow-sm">
